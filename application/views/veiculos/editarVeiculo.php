    ...
    <div class="span12">
        <div class="widget-box">
            ...
            <div class="widget-content nopadding tab-content">
                ...
                <form action="<?php echo current_url(); ?>" id="formVeiculos" method="post" class="form-horizontal">
				<?php echo form_hidden('idVeiculos', $result->idVeiculos) ?>
                  ...
                  <div class="control-group" class="control-label">
                   ...
                   <div class="control-group">
						...
						<div class="controls">
                          <input id="cliente" type="text" name="cliente" value="<?php echo $result->clientes_id ?>" />
                    ...
                    <div class="controls">
                      ...
                      <option selected value="<?php echo $result->combustivel; ?>"><?php echo $result->combustivel; ?></option>
 ...
 $(document).ready(function () {
        $.getJSON('<?php echo base_url() ?>assets/json/montadoras.json', function (data) {
            for (i in data.montadoras) {
                ...
                var curState = '<?php echo $result->montadora; ?>';
                if (curState) {
