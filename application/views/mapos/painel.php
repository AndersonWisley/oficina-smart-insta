...
<ul class="cardBox">
    ...
    <?php endif ?>
        ...
        <li class="card">
            <div>
                <div class="numbers">Veiculos</div>
                <div class="cardName">F2</div>
            </div>
            <a href="<?= site_url('veiculo') ?>">
                <div class="iconBx">
                    <i class='bx bx-package bx-border-circle'></i>
                </div>
            </a>
            ...
            <div class="widget-box-new" style="height:100%">
                ...
                <div class="new-bottons">
                    ...
                    <a href="<?php echo base_url(); ?>index.php/produtos/adicionar" class="card" title="Adicionar Produtos" class="tip-bottom">
					   ...
					   <a href="<?php echo base_url(); ?>index.php/veiculos/adicionar" class="card" title="Adicionar Veiculos" class="tip-bottom">
                        <div><i class='bx bxs-package iconBx2'></i></div>
                        <div>
                            <div class="cardName2"><?= $this->db->count_all('veiculos'); ?></div>
                            <div class="cardName">Add Veiculos</div>
                        </div>
                    </a>
