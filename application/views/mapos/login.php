...
<h2 class="h-two"> Ao Sistema de Controle de Ordens de Serviço</h2>
    <img src="<?php echo base_url() ?>assets/img/carro.png" class="left-login-image" alt="Map-OS - Versão: <?= $this->config->item('app_version'); ?>">
</div>
<div id="loginbox">
        ...
        <div class="container">
          <div class="card">
            <div class="content">
              ...
              <div class="links-uteis"><a href="#"><p><?= date('Y'); ?> &copy; Ander Auto System</p></a>
              </div>
