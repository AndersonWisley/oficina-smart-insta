                                ...
                                <div class="widget-content">
                                    <table class="table table-bordered">
                                        ...
                                        <tr>
											...
											<td>
                                                <label>
                                                    <input name="rVeiculo" class="marcar" type="checkbox" value="1" />
                                                    <span class="lbl"> Relatório Veiculo</span>
                                                </label>
                                            </td>
                                        </tr>
                                        <tr>
