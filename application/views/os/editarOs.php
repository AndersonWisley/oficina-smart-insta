                                ...
                                <form action="<?php echo current_url(); ?>" method="post" id="formOs">
                                    ...
                                    <div class="span12" style="padding: 1%; margin-left: 0">
                                        ...
                                        <div class="span6" style="margin-left: 0">
                                            <label for="cliente">Clientes<span class="required">*</span></label>
										...
										<div class="span3">
                                            ...
                                            <input id="veiculo" class="span12" type="text" name="veiculo" value="<?php echo $result->marca ?>" />
                            ...
                            <div class="span12 well" style="padding: 1%; margin-left: 0">
                                <form id="formProdutos" action="<?php echo base_url() ?>index.php/os/adicionarProduto" method="post">
                                    <div class="span6">
                                        ...
                                        <a href="#modal-produto" id="btn-produto" role="button" data-toggle="modal" class="btn-success" style="min-width: 160px">
                                        <span class=""><i class='bx bx-plus-circle'></i></span><span>Novo</span></a>
                                        </span>
										</label>
...
<div id="modal-produto" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="span12 well" style="padding: 1%; margin-left: 0">
    <form action="<?php echo current_url() ?>index.php/os/adicionarProdutoOutro" id="formProdutosOutro" method="POST" class="form-horizontal">
					...
					<div class="control-group">
                        ...
                        <div class="controls">
                            <input style="width: 9em;" id="precoCompra" class="money" data-affixes-stay="true" data-thousands="" data-decimal="." type="text" name="precoCompra" value="" />
					...
					<div class="control-group">
                     ...
                     <div class="control-group">
                        ...
                        <div class="controls">
                            <input id="estoque" type="text" name="estoque" value="1000" />
                        </div>
                    </div>
                    <div class="form-actions">
                        <div class="span12">
                            <div class="span6 offset3" style="display: flex;justify-content: center">
                                ...
                                <a href="<?php echo base_url() ?>index.php/os" id="" class="button btn btn-mini btn-warning"><span class="button__icon"><i class="bx bx-undo"></i></span><span class="button__text2">Voltar</span></a>
                            </div>
                        </div>
                    </div>
    </form>
		...
		*/
		 ...
		 $("#formProdutosOutro").validate({
            ...
            submitHandler: function(form) {
                    ...
                    $.ajax({
                        type: "POST",
                        url: "<?php echo base_url(); ?>index.php/os/adicionarProdutoOutro",
                        data: dados,
                        dataType: 'json',
                        success: function(data) {
                            if (data.result == true) {
                                ...
                                Swal.fire({
                                    type: "error",
                                    title: "Atenção",
                                    text: "Ocorreu um erro ao tentar adicionar produto Outro."
                                });
                            }
                        }
                    });
