    ...
    $(document).ready(function () {
	 ...
	 $(document).ready(function() {
        ...
        $("#veiculo").autocomplete({
            source: "<?php echo base_url(); ?>index.php/clientes/autoCompleteVeiculo",
            minLength: 1,
            close: function(ui) { if(ui.label == 'Adicionar veiculo...')ui.target.value = '';},
            select: function(event, ui) {
                if(ui.item.label == 'Adicionar veiculo...')
                    $('.addveicul').show();
                else
                    {
