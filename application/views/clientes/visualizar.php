<div class="widget-box">
    <div class="widget-title" style="margin: 0;font-size: 1.1em">
        <ul class="nav nav-tabs">
            <li id="tabClientes" class="active"><a data-toggle="tab" href="#tab1">Dados do Cliente</a></li>
            <li id="tabServicos"><a  data-toggle="tab" href="#tab2">Ordens de Serviço</a></li>
            <li id="tabVeiculos"><a  data-toggle="tab" href="#tab3">Veículos</a></li>
        ...
        <div id="tab2" class="tab-pane" style="min-height: 300px">
            <?php if (!$results) { ?>
                <table class="table table-bordered ">
                    ...
                    <tbody>
                    <tr>
                        <td colspan="6">Nenhuma OS Cadastrada
						<div class="modal-footer" style="display:flex;justify-content: left">
        <?php if ($this->permission->checkPermission($this->session->userdata('permissao'), 'aOs')) {
                echo '<a title="Icon Title" class="button btn btn-mini btn-info" style="min-width: 140px; top:10px" href="' . base_url() . 'index.php/Os/adicionar' . $result->idVeiculos . '">
<span class="button__icon"><i class="bx bx-edit"></i></span> <span class="button__text2"> Adicionar Os</span></a>';
            } ?>
                         </div></td>
                    </tr>
                    </tbody>
        ...
        <div id="tab3" class="tab-pane" style="min-height: 300px">
            <?php if (!$resultss) { ?>
                <table class="table table-bordered ">
                    ...
                    <tbody>
                    <tr>
                        <td colspan="6">Nenhum veiculo Cadastrado
						<div class="modal-footer" style="display:flex;justify-content: left">
        <?php if ($this->permission->checkPermission($this->session->userdata('permissao'), 'eCliente')) {
                echo '<a title="Icon Title" class="button btn btn-mini btn-info" style="min-width: 140px; top:10px" href="' . base_url() . 'index.php/veiculos/adicionar' . $result->idVeiculos . '">
<span class="button__icon"><i class="bx bx-edit"></i></span> <span class="button__text2"> Adicionar Veiculo</span></a>';
            } ?></div></td>
                ...
                <table class="table table-bordered ">
                    ...
                    foreach ($resultss as $r) {
                        ...
                        if ($this->permission->checkPermission($this->session->userdata('permissao'), 'vVeiculo')) {
                            echo '<a href="' . base_url() . 'index.php/veiculos/visualizar/' . $r->idVeiculos . '" style="margin-right: 1%" class="btn tip-top" title="Ver mais detalhes"><i class="fas fa-eye"></i></a>';
                        }
                        if ($this->permission->checkPermission($this->session->userdata('permissao'), 'eVeiculo')) {
                            echo '<a href="' . base_url() . 'index.php/veiculos/editar/' . $r->idVeiculos . '" class="btn btn-info tip-top" title="Editar Veiculo"><i class="fas fa-edit"></i></a>';
                        }
