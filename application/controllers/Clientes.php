...
class Clientes extends MY_Controller
{
    ...
    public function adicionar()
    {
        ...
        if ($this->form_validation->run('clientes') == false) {
            ...
            $data = [
				...
				//'veiculos_id' => $this->input->post('veiculos_id'), //set_value('idVeiculo'),
    ...
    public function visualizar()
    {
		...
		$this->data['resultss'] = $this->clientes_model->getVeiculosByCliente($this->uri->segment(3));
	 ...
	 public function autoCompleteVeiculo()
    {
        if (isset($_GET['term'])) {
            ...
            $this->clientes_model->autoCompleteVeiculo($q);
        }
    }
	*/
}
