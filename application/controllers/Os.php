...
class Os extends MY_Controller
{
    ...
    public function adicionar()
    {
        ...
        if ($this->form_validation->run('os') == false) {
            ...
            $data = [
				...
				'veiculos_id' => $this->input->post('veiculos_id'), //set_value('idUsuario'),
                'dataFinal' => $dataFinal,
    ...
    public function editar()
    {
        ...
        if ($this->form_validation->run('os') == false) {
            ...
            $data = [
				...
				'veiculos_id' => $this->input->post('veiculos_id'),
            ];
	  ...
	  public function autoCompleteVeiculo()
    {
        if (isset($_GET['term'])) {
            $q = strtolower($_GET['term']);
            $this->os_model->autoCompleteVeiculo($q);
        }
    }
	...
	//----------------------------------
	 public function adicionarProdutoOutro()
    {
